...
class Level61(Level):
    def __init__(self):
        Level.__init__(self)
        self.num_enemies = 2
        self.spawn_intervals = [5,5]
        self.phase_counts = [1,2]
        self.enemy_types = [102,103]

class Level62(Level):
    def __init__(self):
        Level.__init__(self)
        self.num_enemies = 2
        self.spawn_intervals = [8,1]
        self.phase_counts = [1,2]
        self.enemy_types = [102,11]
...
max_level = 62  # TODO get this from last key in levels
